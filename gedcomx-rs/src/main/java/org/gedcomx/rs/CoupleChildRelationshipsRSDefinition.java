...
public interface CoupleChildRelationshipsRSDefinition {
  ...
  public static final String REL = "couple-child-relationships";

  /**
   * Create a couple-child relationship.
   *
   * @param relationship The couple-child relationship to be created.
