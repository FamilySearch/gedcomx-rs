  ...
  states = {
    @StateDefinition (
      ...
      transitions = {
        ...
        @StateTransition (rel = CurrentUserPersonQuery.REL, description = "The link to the current user person of the application.", template = true, conditional = true ),
        @StateTransition (rel = CurrentUserQuery.REL, description = "The link to the current user of the application.", template = true, conditional = true ),
